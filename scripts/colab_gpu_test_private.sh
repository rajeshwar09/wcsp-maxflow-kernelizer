...
#
# Clones the latest pushed code from the private GitHub repo and
# runs whichever component's tests asked for. Use this every time
# when pushed new commits and want to verify them on a real GPU
#
